cordova.define("cordova-plugin-calendar.Calendar", function(require, exports, module) {
    ...
    Calendar.prototype.listEventAttendees = function (event_id, successCallback, errorCallback) {
        cordova.exec(successCallback, errorCallback, "Calendar", "listEventAttendees", [{
            "event_id": event_id
        }])
    };
